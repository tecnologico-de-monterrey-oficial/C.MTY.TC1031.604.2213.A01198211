...
public:
  ...
  int findData(string data); // * Regresa el indice donde se encontruentra el
                             // valor buscado
  int Size();
  void insert(int index,
              BoatLog data); // *Inserta un elemento después del índice dado
  void deleteData(
      string); // *Elimina el elemento dado (El primero que encuentre)
...
int DoubleLinkedListE::Size() { return size; }
...
BoatLog &DoubleLinkedListE::getTail() { return tail->data; }
