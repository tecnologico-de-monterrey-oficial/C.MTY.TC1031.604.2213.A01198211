...
template <class T> int BST<T>::howManyChilds(NodeT<T> *aux) {
...
template <class T> bool BST<T>::find(T data) {
  // Creamos un nodo auxiliar igual a root
  NodeT<T> *aux = root;
...
template <class T> void BST<T>::remove(T data) {
...
template <class T> void BST<T>::printTree(NodeT<T> *aux, int level) {
  if (aux != NULL) {
...
template <class T> void BST<T>::preOrder(NodeT<T> *aux) {
...
template <class T> void BST<T>::inOrder(NodeT<T> *aux) {
  // Condición de control para salir de la recursividad
  if (aux != nullptr) {
...
template <class T> void BST<T>::postOrder(NodeT<T> *aux) {
  // Condición de control para salir de la recursividad
  if (aux != nullptr) {
    // inOrder del arbol izquierdo
    postOrder(aux->left);
...
template <class T> void BST<T>::preOrderConverse(NodeT<T> *aux) {
  // Condición de control para salir de la recursividad
  if (aux != nullptr) {
    // visita el nodo raíz del arbol
    cout << aux->data << " ";
...
template <class T> void BST<T>::inOrderConverse(NodeT<T> *aux) {
  // Condición de control para salir de la recursividad
  if (aux != nullptr) {
    // inOrder del arbol derecho
...
template <class T> void BST<T>::postOrderConverse(NodeT<T> *aux) {
  // Condición de control para salir de la recursividad
  if (aux != nullptr) {
    // inOrder del arbol derecho
...
template <class T> void BST<T>::order(int type) {
  switch (type) {
  case 1: // 1 -> PreOrder
    preOrder(root);
    break;
...
template <class T> bool BST<T>::isEmpty() { return root == nullptr; }
#endif
